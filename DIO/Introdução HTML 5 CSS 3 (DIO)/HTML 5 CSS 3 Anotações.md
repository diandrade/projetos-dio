...
<section> = Sessão Genérica de conteudo.
<header> = Cabeçalho da página.
<article> = Conteudo Relevante dentro da página.
<aside> = Conteudo Relacionado ao conteudo principal da página.
<footer> = Rodapé da página ou parte dela.
<h1><h6> = Importância dos títulos.

<h1> = Título da página
<h2> = Título da seção
<h3> = Título de artigo
<p> = Conteudo de artigo

<a> = Ancora responsavel por interligar as coisas estabelecendo links.
ex: <a href="https://www.linkedin.com/in/andradedossantosdiego/">Linkedin</a>
href = Hyperlink.
target = Como o link será aberto.

<img>

<img src = "img/avatar.jpg">
<img alt = "Foto de Diego Andrade">

<ul> = Lista Desordenada.
<ol> = Lista Ordenada.
<li> = Item dessas listas.