...
Seletores que derivam do HTML

Declarações com função de mudança de estilo

ID X CLASSE

Id só pode ser utilizado uma vez na página, ao contrário da classe que é utilizada para definir um padrão geral.
